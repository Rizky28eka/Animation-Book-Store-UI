...
import '../../shared/widgets/leading_rotation_widget.dart';
import 'widgets/liked_book_widget.dart';
    ...
    return Column(
      ...
      children: [
        ...
        SlideTransition(
          ...
          child: const Padding(
            padding:
                EdgeInsets.symmetric(horizontal: screenHorizontalPadding * 2),
            child: Text(
              'Most likes',
              style: TextStyle(
                  fontSize: 18, color: whiteColor, fontWeight: FontWeight.w800),
            ),
          ),
        ),
            ...
            child: NotificationListener<ScrollNotification>(
              ...
              child: ListView.separated(
                padding: const EdgeInsets.symmetric(
                    horizontal: screenHorizontalPadding * 2),
