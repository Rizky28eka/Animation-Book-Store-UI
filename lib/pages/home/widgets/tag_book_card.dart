...
class _TagBookCardState extends State<TagBookCard>
  ...
  void _onCardTap() async {
    ...
    if (context.mounted)
      Navigator.of(context).pushNamed('/detail',
          arguments: {'book': widget.book, 'sourceWidgetKey': widget.key});
  }
          ...
          child: Stack(
            children: [
              Hero(
                ...
                child: ColorFiltered(
                  colorFilter:
                      const ColorFilter.mode(blackColorOp015, BlendMode.darken),
                  child: Image.asset(
